...
parser.add_argument('--dataset', type=str, default="Physics",choices=["Cora","CiteSeer","PubMed","Photo","CS","ogbn-arxiv","Physics"])
...
parser.add_argument('--w1', type=float, default= 1.5, help='dynatic loss')
...
parser.add_argument('--alpha2', type=float, default=0.4)
